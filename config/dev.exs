...
config :framelens, Framelens.Repo,
  ...
  database: System.get_env("DATABASE_NAME") || "framelens_dev",
  stacktrace: true,
...
config :framelens, FramelensWeb.Endpoint,
  ...
  http: [
    ip: if(System.get_env("DOCKER_ENV"), do: {0, 0, 0, 0}, else: {127, 0, 0, 1}),
...
config :framelens, FramelensWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/framelens_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :framelens, dev_routes: true
